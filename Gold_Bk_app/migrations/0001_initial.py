# Generated by Django 4.1.2 on 2022-10-24 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_activo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Gold_Bk_app.activo')),
                ('id_cuenta', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Gold_Bk_app.cuenta')),
            ],
        ),
        migrations.AddField(
            model_name='cuenta',
